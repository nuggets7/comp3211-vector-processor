...
module pipelined_processor(
    ...
    wire id_rs_required_in_id = (id_opcode == 6'b000100) /* JR */ | (id_opcode == 6'b001101) /* OUT */;
    
    wire hazard_in_ex = idex_REG_WRITE && (idex_write_reg != 5'd0) && (idex_write_reg == id_rs);
    wire hazard_in_mem = exmem_REG_WRITE && (exmem_write_reg != 5'd0) && (exmem_write_reg == id_rs);
    wire hazard_in_wb = memwb_REG_WRITE && (memwb_write_reg != 5'd0) && (memwb_write_reg == id_rs);
    ...
    wire [31:0] exmem_forward_data = exmem_is_cop ? exmem_cop_result : exmem_alu_result;
